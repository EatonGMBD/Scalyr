...
Scalyr <- {
    ...
    _arrayEvents  					= [],		// Array of events, containing the data generated by addEvent, and sent to Scalyr using _sendAddEvents
	...
	function _sendAddEvents(){
		...
		this._arrayEvents = [];	// Clean up our pointer to the Events array, since we are about to send the data

		return this._createRequestPromise("POST", url, this._defaultHeaders, body)
	}

	function _onLockoutTimerExpiredSendAddEvents(){
